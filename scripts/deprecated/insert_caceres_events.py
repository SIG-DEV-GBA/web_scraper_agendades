"""Insert Cáceres (Extremadura) events from viralagenda.com."""
...
SOURCE_ID = "viralagenda_caceres"
CCAA = "Extremadura"
PROVINCE = "Cáceres"


async def main(limit: int = 30, dry_run: bool = False):
    """Fetch, enrich and insert Cáceres events from viralagenda."""
    print(f"\n{'='*60}")
    print(f"VIRALAGENDA CÁCERES - Insercion de eventos")
    ...
    print("1. Fetching events from viralagenda.com/caceres...")
