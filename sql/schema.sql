...
CREATE TABLE public.event_source_contributions (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  event_id uuid NOT NULL,
  ...
  fields_contributed ARRAY DEFAULT '{}'::text[],
  quality_score integer DEFAULT 0,
  is_primary boolean DEFAULT false,
  CONSTRAINT event_source_contributions_pkey PRIMARY KEY (id),
  CONSTRAINT event_source_contributions_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.events(id),
  CONSTRAINT event_source_contributions_source_id_fkey FOREIGN KEY (source_id) REFERENCES public.scraper_sources(id)
);
